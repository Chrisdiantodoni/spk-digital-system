    ...
    <>
      {uncontrol ? (
                ...
                >
                 ...
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll ${className}`}
                    >
                      ...
                      >
                        <h2 className="capitalize leading-6 tracking-wider font-medium text-lg ">
                          {title}
                        </h2>
                        <button
                          onClick={closeModal}
                          className="text-[22px] hover:bg-slate-100 rounded-md"
                        >
                          <X />
                        </button>
                      </div>
        ...
        <Transition appear show={activeModal} as={Fragment}>
          <Dialog
            as="div"
            className={`relative z-[99999] ${parentClass}`}
            onClose={onClose}
          >
            <Transition.Child
              as={Fragment}
                 ...
                 bg-white dark:bg-slate-800 text-left align-middle shadow-xl transition-alll ${className}`}
                  >
                    <div
                      className={`relative overflow-hidden py-4 px-5 flex justify-between  ${themeClass}`}
                    >
                      <h2 className="capitalize leading-6 tracking-wider text-black font-medium text-lg">
                        {title}
                      </h2>
                      <button
                        onClick={onClose}
