...
const FormAdditionalFilesInstance = ({
  customerFiles,
  ...
  return (
    <div className="grid grid-cols-12 col-span-12 gap-6 my-10">
      <ModalImage />
      ...
      <div className="col-span-12 flex items-start w-full">
        <p className="detail-label">Dokumen Tambahan</p>
...
export default FormAdditionalFilesInstance;
