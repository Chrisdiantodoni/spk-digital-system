    ...
    <Container>
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-12 lg:col-span-3">
          <DatePicker value={selectedDates?.startDate} label="Tanggal Awal" />
        </div>
        <div className="col-span-12 lg:col-span-3">
          <DatePicker value={selectedDates?.endDate} label="Tanggal Akhir" />
        </div>
        <div className="col-span-12 lg:col-span-3">
          <SelectGroup
            label="Status"
        ...
        <div className="col-span-12 items-center ">
          <div className="grid grid-cols-1 lg:flex gap-5">
            <Button
              label="ADD NEW PO"
              isButton={false}
              to={'/transaction/po-instance/form'}
            ...
            {/* <Button
              ...
              to={`/units/delivery?type=spk_instance`}
            /> */}
          </div>
        </div>
            ...
            data={data?.data?.data?.map((item: any, index: number) => ({
              ...
              action: [
                <Button
                  isButton={false}
                  label="DETAIL"
                  to={`/transaction/po-instance/${item.spk_id}`}
